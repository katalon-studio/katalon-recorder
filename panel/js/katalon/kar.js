    ...
    $('#ka-upload').on('click', function() {
        $.ajax({
            ...
            error: function(response) {
                ...
                showDialog('<img class="kto-light" style="max-width: 50%;" src="../../../katalon/images/Branding/Katalon TestOps/Full/Large 333px/Katalon-TestOps-full-color-large-w.png" alt="Katalon TestOps" /><img class="kto-dark" style="max-width: 50%;" src="../../../katalon/images/Branding/Katalon TestOps/Full/Large 333px/Katalon-TestOps-full-color-large.png" alt="Katalon TestOps" /><p>Please log in to <a target="_blank" href="https://analytics.katalon.com" class="katalon-link">Katalon TestOps (beta)</a> first and try again.</p><p>You can register a completely free account at <a target="_blank" href="https://www.katalon.com" class="katalon-link">katalon.com</a>.</p><p>Katalon TestOps helps you manage automation results as you test it manually and generate quality, performance and flakiness reports to improve your confidence in evaluating the test results. Katalon TestOps supports both <a target="_blank" href="https://www.katalon.com" class="katalon-link">Katalon Studio</a> (one of the top 10 test automation solutions) and Katalon Recorder.</p><p><a target="_blank" href="https://www.katalon.com/testops/" class="katalon-link">Learn more</a> about Katalon TestOps (Beta).</p>', true);
            }
        });
    });
});
